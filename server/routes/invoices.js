...
<head>
  ...
  <style>
    ...
    .invoice-title { font-size: 20px; font-weight: 600; color: #4a5568; text-align: right; }
  ...
  <div class="container">
    <div class="header">
      ...
      <div>
        ...
        <div style="font-size: 13px; color: #718096; text-align: right; margin-top: 4px;"># ${invoice.invoice_number}</div>
      </div>
    </div>
    ...
    <div class="meta-grid">
      <div>
        ...
        <div style="color: #4a5568;">${invoice.client_email}</div>
      </div>
      <div style="text-align: right;">
        <div class="label">Date Issued</div>
        <div class="value">${invoice.issue_date}</div>
        \${invoice.due_date ? \`<div class="label" style="margin-top: 10px;">Due Date</div><div class="value">\${invoice.due_date}</div>\` : ''}
      </div>
    </div>
    ...
    <div class="table-container">
      <table>
        ...
        <tbody>
          <tr>
            <td>Photography Services / Package Bill</td>
    ...
    <div class="footer">
      Thank you for your business! If you have any questions, please contact ${studioName} directly.
    </div>
  </div>
</body>
</html>
